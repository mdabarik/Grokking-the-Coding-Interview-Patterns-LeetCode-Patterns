# Coding Interview Patterns — Course Outline

## Overview
This course is divided into 4 parts, designed so that students complete one part and naturally want to move to the next.
...
### HashMap
1. First Unique Char in a String
2. Largest Unique Number
3. Maximum Number of Balloons
...
4. Linked List Cycle - Detect Loop
...
4. Delete Nodes Having Greater Value on Right
...
9. Maximum sum of Non-adjacent nodes
...
6. Minimum Number of Vertices to Reach All Nodes
7. Rotten Oranges
8. Evaluate Division
9. Short Bridge
...
4. Find Smallest Letter Than Target
...
12. Median of Two Sorted Array

### Top K Elements
1. K Largest Elements
2. Kth Largest Elements
...
10. Sum of elements between k1'th and k2'th smallest elements
...
4. Split a String Into the Max Number of Unique Substrings
...
5. Removing Minimum and Maximum From Array
...
### Topological Sort
1. Topological Sort
2. Minimum Spanning Tree - Union Find
...
### Union Find
1. Union Find
2. Check Graph Cycle - Using Union Find
...
7. Unique Paths
8. Valid Sudoku
9. Min Flips to make binary string alternate
...
19. Lowest Common Ancestor of Binary Search Tree
20. KMP - Knuth Morris Pratt
21. LPS Array - Longest Prefix Suffix Array
